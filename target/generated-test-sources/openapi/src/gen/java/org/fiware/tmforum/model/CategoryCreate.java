...
public class CategoryCreate   {
  ...
  public CategoryCreate removeProductOfferingItem(ProductOfferingRef productOfferingItem) {
  ...
  public CategoryCreate removeSubCategoryItem(CategoryRef subCategoryItem) {
