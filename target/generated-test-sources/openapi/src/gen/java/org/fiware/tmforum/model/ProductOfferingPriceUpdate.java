...
public class ProductOfferingPriceUpdate   {
  ...
  public ProductOfferingPriceUpdate removeBundledPopRelationshipItem(BundledProductOfferingPriceRelationship bundledPopRelationshipItem) {
  ...
  public ProductOfferingPriceUpdate removeConstraintItem(ConstraintRef constraintItem) {
  ...
  public ProductOfferingPriceUpdate removePlaceItem(PlaceRef placeItem) {
  ...
  public ProductOfferingPriceUpdate removePopRelationshipItem(ProductOfferingPriceRelationship popRelationshipItem) {
  ...
  public ProductOfferingPriceUpdate removePricingLogicAlgorithmItem(PricingLogicAlgorithm pricingLogicAlgorithmItem) {
  ...
  public ProductOfferingPriceUpdate removeProdSpecCharValueUseItem(ProductSpecificationCharacteristicValueUse prodSpecCharValueUseItem) {
  ...
  public ProductOfferingPriceUpdate removeProductOfferingTermItem(ProductOfferingTerm productOfferingTermItem) {
  ...
  public ProductOfferingPriceUpdate removeTaxItem(TaxItem taxItem) {
