...
public class ProductOffering   {
  ...
  public ProductOffering removeAgreementItem(AgreementRef agreementItem) {
  ...
  public ProductOffering removeAttachmentItem(AttachmentRefOrValue attachmentItem) {
  ...
  public ProductOffering removeBundledProductOfferingItem(BundledProductOffering bundledProductOfferingItem) {
  ...
  public ProductOffering removeCategoryItem(CategoryRef categoryItem) {
  ...
  public ProductOffering removeChannelItem(ChannelRef channelItem) {
  ...
  public ProductOffering removeMarketSegmentItem(MarketSegmentRef marketSegmentItem) {
  ...
  public ProductOffering removePlaceItem(PlaceRef placeItem) {
  ...
  public ProductOffering removeProdSpecCharValueUseItem(ProductSpecificationCharacteristicValueUse prodSpecCharValueUseItem) {
  ...
  public ProductOffering removeProductOfferingPriceItem(ProductOfferingPriceRefOrValue productOfferingPriceItem) {
  ...
  public ProductOffering removeProductOfferingRelationshipItem(ProductOfferingRelationship productOfferingRelationshipItem) {
  ...
  public ProductOffering removeProductOfferingTermItem(ProductOfferingTerm productOfferingTermItem) {
